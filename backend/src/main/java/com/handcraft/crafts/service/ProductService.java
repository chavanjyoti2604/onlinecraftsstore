...
public class ProductService {
    ...
    public Product addProduct(int shopId, Product product) {
        ...
        product.setShop(shop); // associate product with shop
    ...
    public List<ProductWithShopDTO> getAllProductsWithShops() {
        return productRepository.findAllProductsWithShopInfo();
    }
}
